...
typedef enum            //命令码
{
    DELETE_UI_DATA_CMD_ID = 0x0100,              //删除命令
    DRAW_GRAPHIC_SINGLE_DATA_CMD_ID = 0x0101,    //一个图形
    DRAW_GRAPHIC_DOUBLE_DATA_CMD_ID = 0x0102,    //二个图形
    DRAW_GRAPHIC_FIVE_DATA_CMD_ID   = 0x0103,    //五个图形
    DRAW_GRAPHIC_SEVEN_DATA_CMD_ID  = 0x0104,    //七个图形
    DRAW_STRING_DATA_CMD_ID         = 0x0110,    //字符串
} UI_CMD_ID_e;
