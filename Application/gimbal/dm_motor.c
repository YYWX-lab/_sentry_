...
//  */
// void DM_Motor_Init(CAN_HandleTypeDef *hcan, uint8_t __CAN_Rx_ID, uint8_t __CAN_Tx_ID, Enum_Motor_DM_Control_Method __Motor_DM_Control_Method, float __Angle_Max, float __Omega_Max, float __Torque_Max, float __Current_Max)
// {
//     Struct_Motor_DM_Normal Struct_Motor_DM_Normal;

//     Struct_Motor_DM_Normal.CAN_Rx_ID = __CAN_Rx_ID;
//     switch (__Motor_DM_Control_Method)
//     {
//     case (Motor_DM_Control_Method_NORMAL_MIT):
//     {
//         Struct_Motor_DM_Normal.CAN_Tx_ID = __CAN_Tx_ID;
//         break;
//     }
//     case (Motor_DM_Control_Method_NORMAL_ANGLE_OMEGA):
//     {
//         Struct_Motor_DM_Normal.CAN_Tx_ID = __CAN_Tx_ID + 0x100;
//         break;
//     }
//     case (Motor_DM_Control_Method_NORMAL_OMEGA):
//     {
//         Struct_Motor_DM_Normal.CAN_Tx_ID = __CAN_Tx_ID + 0x200;
//         break;
//     }
//     case (Motor_DM_Control_Method_NORMAL_EMIT):
//     {
//         Struct_Motor_DM_Normal.CAN_Tx_ID = __CAN_Tx_ID + 0x300;
//         break;
//     }
//     }
//     Struct_Motor_DM_Normal.Motor_DM_Control_Method = __Motor_DM_Control_Method;
//     Struct_Motor_DM_Normal.Angle_Max = __Angle_Max;
//     Struct_Motor_DM_Normal.Omega_Max = __Omega_Max;
//     Struct_Motor_DM_Normal.Torque_Max = __Torque_Max;
//     Struct_Motor_DM_Normal.Current_Max = __Current_Max;
// }
...
//  *
//  */
// void CAN_Send_Clear_Error(CAN_Object_t* obj, uint8_t CAN_Tx_ID)
// {
//     BSP_CAN_TransmitData(obj, CAN_Tx_ID, DM_Motor_CAN_Message_Clear_Error, 8);
// }
...
//  *
//  */
// void CAN_Send_Enter(CAN_Object_t* obj, uint8_t CAN_Tx_ID)
// {
//     BSP_CAN_TransmitData(obj, CAN_Tx_ID, DM_Motor_CAN_Message_Enter, 8);
// }
...
//  *
//  */
// void CAN_Send_Exit(CAN_Object_t* obj, uint8_t CAN_Tx_ID)
// {
//     BSP_CAN_TransmitData(obj, CAN_Tx_ID, DM_Motor_CAN_Message_Exit, 8);
// }
...
//  *
//  */
// void CAN_Send_Save_Zero(CAN_Object_t* obj, uint8_t CAN_Tx_ID)
// {
//     BSP_CAN_TransmitData(obj, CAN_Tx_ID, DM_Motor_CAN_Message_Save_Zero, 8);
// }
...
//  *
//  */
// void DM_Motor_Data_Process( uint8_t data[])
// {
//     // 数据处理过程
//     int32_t delta_encoder;
//     uint16_t tmp_encoder, tmp_omega, tmp_torque;
//     dm_motor_data dm_motor_data;
//     dm_motor_data.angle = data[1] << 8 | data[2];
//     dm_motor_data.vel = data[3] << 8 | data[4] >> 4;
//     dm_motor_data.torque = (data[4] & 0x0f) << 8 | data[5];
//     dm_motor_data.MOS_Temperature = data[6];
//     dm_motor_data.Rotor_Temperature = data[7];
//     // // 处理大小端
