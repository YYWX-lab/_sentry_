...
void BSP_Init(void)
{
    ...
    // BSP_GPIO_NewObject(&key_gpio, GPIO_INPUT_DEV, KEY_GPIO_Port, KEY_Pin);
    BSP_GPIO_NewObject_EXTI(&key_gpio, KEY_GPIO_Port, KEY_Pin, key_callback);
