 ...
 * Copyright (C) 2015-2018 Arm Limited and ARM Germany GmbH. All rights reserved.
 *------------------------------------------------------------------------------
 * Name:    Web.c
...
/* Last-Modified: Fri, 02 Feb 2018 08:40:01 GMT */
const uint32_t imageLastModified = 1517560801U;
